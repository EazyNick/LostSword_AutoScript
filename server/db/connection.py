...
class DatabaseConnection:
    ...
    def execute_with_connection(self, callback: Callable[[sqlite3.Connection, sqlite3.Cursor], Any]) -> Any:
        """
...
if __name__ == "__main__":
    ...
    print("✅ execute_with_connection 실행 성공")
    ...
    try:
        ...
        def error_callback(conn: sqlite3.Connection, cursor: sqlite3.Cursor) -> None:
    ...
    print("   - 설명: db_path 인자를 전달하지 않으면 자동으로 workflows.db 사용\n")
