...
class NodeExecutionContext:
    ...
    def add_node_result(self, node_id: str, node_name: Optional[str], result: Dict[str, Any]):
        """
        노드 실행 결과를 추가합니다.
    ...
    def get_node_result(self, node_id: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """
        특정 노드의 실행 결과를 가져옵니다.
    ...
    def get_node_result_by_name(self, node_name: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_previous_node_result(self) -> Optional[Dict[str, Any]]:
        """
        이전 노드의 실행 결과를 가져옵니다.
