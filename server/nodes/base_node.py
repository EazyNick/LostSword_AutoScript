...
from utils import validate_parameters, normalize_result
...
class BaseNode(ABC):
    ...
    @staticmethod
    def _validate_and_normalize_parameters(parameters: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
        파라미터를 검증하고 정규화합니다.
    ...
    @staticmethod
    def _create_result(action: str, status: str = "completed", output: Any = None, 
