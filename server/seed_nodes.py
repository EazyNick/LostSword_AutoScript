    ...
    try:
        ...
        nodes_data = [
            ...
            },
            {
                ...
                "data": {"title": "로그인 성공 확인", "color": "orange", "condition": "check_login_success"},
            },
            {
                "id": "node4",
                "type": "action",
        ...
        nodes_data_2 = [
            ...
            },
            {
                ...
                "type": "wait",
                "position": {"x": 50400, "y": 49900},
                "data": {"title": "결제 처리 대기", "color": "purple", "duration": 3000},
            },
            {
                "id": "node4",
                "type": "condition",
                "position": {"x": 50600, "y": 49900},
                "data": {"title": "결제 성공 확인", "color": "orange", "condition": "check_payment_success"},
            },
            {
                "id": "end",
                "type": "end",
