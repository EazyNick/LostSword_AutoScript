...
이 폴더는 LostSword AutoScript의 노드 시스템에 대한 상세한 문서를 포함합니다.
...
LostSword AutoScript의 노드 시스템은 워크플로우를 구성하는 기본 단위입니다. 각 노드는 특정 작업을 수행하며, 노드들을 연결하여 복잡한 자동화 스크립트를 만들 수 있습니다.
